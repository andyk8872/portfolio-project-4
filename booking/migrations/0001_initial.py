# Generated by Django 3.2.18 on 2023-03-02 03:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_type', models.CharField(choices=[('TBW', 'Team Building Workshop'), ('CTC', 'Carnival Team Challenge'), ('BBC', 'Bridge Building Challenge')], default='BBC', max_length=256, verbose_name='Activity Type')),
                ('booking_date', models.DateField(blank=True, null=True, unique=True, verbose_name='Booking date')),
